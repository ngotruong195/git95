...
namespace QLKhoHang
{
	class DbHelper
	{
		...
		static string connString = @"Data Source=.\SQLEXPRESS;Initial Catalog=QLKhoHang;Integrated Security=True";
		...
		internal static void ExportExcel(object dataGridView1)
		{
